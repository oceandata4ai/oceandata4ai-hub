...
SECTIONS = [
    ...
    ("H. Ask OUG", f"{DEMO_URL}qa/oug-help.html", [
        ("Q-01", "Banner", "M1 · On-site Q&A demo · Browse topics below; posting opens after legal review", "顶栏"),
        ("Q-03", "H1", "OceanBase User Group Q&A", "标题"),
        ("Q-04", "描述", "Your go-to space for troubleshooting and how-to help on OceanBase, seekdb, and production deployments.", "正文"),
        ("Q-08", "注册", "Sign up for Ask OUG", "标题"),
        ("Q-14", "验证", "Check your email — Verify email from The OceanData4AI Community", "邮件流"),
        ("Q-15", "发帖", "Start a discussion — Ask the OceanBase User Group community.", "正文"),
    ]),
