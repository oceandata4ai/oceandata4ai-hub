...
Static HTML Hub matching **Phase 1 PRD** — 7 pages + **OUG Discussion (M1)** + SaaS outbound links. No build step.
...
| **OUG Discussion** | https://oceandata4ai.github.io/oceandata4ai-hub/qa/oug-help.html |
...
- **OUG Discussion** in nav → Speckle-style topic list (Discourse hosted after legal review)
...
| `qa/oug-help.html` | **M1** OUG Discussion — community Q&A |
