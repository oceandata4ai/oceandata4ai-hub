...
Static HTML Hub matching **Phase 1 PRD** — 7 pages + **dual Q&A (M1)** + SaaS outbound links. No build step.
...
| **OUG Help (Q&A)** | https://oceandata4ai.github.io/oceandata4ai-hub/qa/oug-help.html |
| **O4AI Chat (Q&A)** | https://oceandata4ai.github.io/oceandata4ai-hub/qa/o4ai-chat.html |
...
- **Q&A dropdown** in nav → OUG Help + O4AI Chat (Speckle-style topic lists; Discourse hosted after legal review)
...
| `qa/oug-help.html` | **M1** Product & deployment Q&A |
| `qa/o4ai-chat.html` | **M1** AI infra open discussion |
